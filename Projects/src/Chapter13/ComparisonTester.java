...
public class ComparisonTester {
    public static void main(String[] args) {
        ...
        switch (comparison.compareVolume()){
            case -1: {
                System.out.println("The second object has a larger volume");
                break;
            }
            case 1: {
                System.out.println("The first object has a larger volume");
                break;
            }
            case 0: {
                System.out.println("The volume are the same");
                break;
            }
        }
    }
