        ...
        do{
            ...
            switch (ans){
                case '1':{
                    ...
                    int[] inputs = getInput();
                    boolean ok = table.makeBooking(inputs[0],inputs[1],myBooking);
                    if (ok){
                ...
                case '2':{
                    int[] inputs = getInput();
                    boolean ok = table.cancelBooking(inputs[0],inputs[1]);
                    if (ok){
                        System.out.println("Done!");
                    }
                    else {
                ...
                case '4':{
                    int[] inputs = getInput();
                    Booking myBooking = table.getBooking(inputs[0],inputs[1]);
                    if(myBooking != null){
                        System.out.println("Room number: "+myBooking.getRoom());
                        System.out.println("Lecture name: "+myBooking.getName());
                    }
                    else {
